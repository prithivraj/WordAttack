...
public final class LogUtils {
    ...
    public static void v(Object obj) {
        ...
        String msg = obj != null ? obj.toString() : "obj == null"; //No i18n
        Log.v(tag, msg);
    }
    ...
    public static void print(Object object) {
        ...
        String content = "";
        if (object != null) {
            content = object.toString() + "                    ----    " //No i18n
                    + method;
        } else {
            content = " ## " + "                ----    " + method; //No i18n
        }
        Log.d(tag, content);
    ...
    private static String getCallHierarchy() {
        ...
        for (int i = 2; i < trace.length; i++) {
            result += "\r\t" + trace[i].getClassName() + "." //No i18n
                    + trace[i].getMethodName() + "():" //No i18n
    ...
    private static String callMethodAndLine() {
        String result = "at "; //No i18n
        StackTraceElement thisMethodStack = (new Exception()).getStackTrace()[2];
        result += thisMethodStack.getClassName() + "."; //No i18n
        result += thisMethodStack.getMethodName();
        result += "(" + thisMethodStack.getFileName(); //No i18n
        result += ":" + thisMethodStack.getLineNumber() + ")  "; //No i18n
        return result;
    }
