...
public final class BitmapUtil {
    ...
    public static Bitmap getBitmapFromView2(View view) {
        ...
        if (cacheBitmap == null) {
            if (DEBUG) {
                Log.e(TAG, "failed getViewBitmap(" + view + ")", //No i18n
    ...
    public static Bitmap blur(Context context, Bitmap sentBitmap, int radius) {
        ...
        if (radius < 0) {
            radius = 0;
            if (DEBUG) {
                LogUtils.w(TAG, "radius must be 0 < r < 25 , forcing radius=0"); //No i18n
            }
        } else if (radius > 25) {
            radius = 25;
            if (DEBUG) {
                LogUtils.w(TAG, "radius must be 0 < r < 25 , forcing radius=25"); //No i18n
            }
        }
        ...
        int[] pix = new int[w * h];
        Log.e("pix", w + " " + h + " " + pix.length); //No i18n
