...
public class ImsiUtil {
    ...
    private String imsi_1 = ""; //No i18n
    private String imsi_2 = ""; //No i18n
    private String imei_1 = ""; //No i18n
    private String imei_2 = ""; //No i18n
    ...
    public IMSInfo initMtkSecondDoubleSim() {
        ...
        try {
            ...
            Method mx = TelephonyManager.class.getMethod("getDefault", //No i18n
                    int.class);
    ...
    public IMSInfo initSpreadDoubleSim() {
        ...
        try {
            Class<?> c = Class
                    .forName("com.android.internal.telephony.PhoneFactory"); //No i18n
            Method m = c.getMethod("getServiceName", String.class, int.class); //No i18n
    ...
    public IMSInfo initQualcommDoubleSim() {
        ...
        try {
            Class<?> cx = Class
                    .forName("android.telephony.MSimTelephonyManager"); //No i18n
            Object obj = mContext.getSystemService("phone_msim"); //No i18n
            Method md = cx.getMethod("getDeviceId", int.class); //No i18n
            Method ms = cx.getMethod("getSubscriberId", int.class); //No i18n
            ...
            boolean flag = false;
            try {
                Method mx = cx.getMethod("getPreferredDataSubscription", //No i18n
                        int.class);
                Method is = cx.getMethod("isMultiSimEnabled", int.class); //No i18n
                statephoneType_2 = (Integer) mx.invoke(obj);
                flag = (Boolean) is.invoke(obj);
            } catch (Exception e) {
            }
            imsInfo = new IMSInfo();
            imsInfo.chipName = "高通芯片-getPreferredDataSubscription:" //No i18n
                    + statephoneType_2 + ",flag:" + flag; //No i18n
            imsInfo.imei_1 = imei_1;
            imsInfo.imei_2 = imei_2;
            imsInfo.imsi_1 = imsi_1;
            imsInfo.imsi_2 = imsi_2;
    ...
    public IMSInfo getIMSI() {
        ...
        if (TextUtils.isEmpty(imsi_1) || imsi_1.length() < 10) {
            ...
            imsInfo = new IMSInfo();
            imsInfo.chipName = "单卡芯片"; //No i18n
            imsInfo.imei_1 = imei_1;
            imsInfo.imei_2 = "没有"; //No i18n
            imsInfo.imsi_1 = imsi_1;
            imsInfo.imsi_2 = "没有"; //No i18n
            return imsInfo;
        }
    }
