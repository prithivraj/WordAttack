...
public final class ViewUtils {
    ...
    private static final String CLASS_NAME_GRID_VIEW = "android.widget.GridView";//No i18n
    private static final String FIELD_NAME_VERTICAL_SPACING = "mVerticalSpacing";//No i18n
