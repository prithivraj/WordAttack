...
public final class DateUtils {
     ...
     * 日期类型 *
     */
   /* public static final String yyyyMMDD = "yyyy-MM-dd"; //No i18n
    public static final String yyyyMMddHHmmss = "yyyy-MM-dd HH:mm:ss"; //No i18n
    public static final String HHmmss = "HH:mm:ss"; //No i18n
    public static final String hhmmss = "HH:mm:ss"; //No i18n
    public static final String LOCALE_DATE_FORMAT = "yyyy年M月d日 HH:mm:ss"; //No i18n
    public static final String DB_DATA_FORMAT = "yyyy-MM-DD HH:mm:ss"; //No i18n
    public static final String NEWS_ITEM_DATE_FORMAT = "hh:mm M月d日 yyyy"; //No i18n*/
    ...
    public static String translateDate(Long time) {
        ...
        if (time >= todayStartTime && time < todayStartTime + oneDay) { // today
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); //No i18n
    ...
    private String translateDate(long time, long curTime) {
        ...
        if (time >= todayStartTime) {
            ...
            if (d <= 60) {
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat("今天 HH:mm"); //No i18n
            ...
            if (time < todayStartTime && time > todayStartTime - oneDay) {
                SimpleDateFormat dateFormat = new SimpleDateFormat("昨天 HH:mm"); //No i18n
                Date date = new Date(time * 1000);
                String dateStr = dateFormat.format(date);
                if (!TextUtils.isEmpty(dateStr) && dateStr.contains(" 0")) {
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat("前天 HH:mm"); //No i18n
                Date date = new Date(time * 1000);
                String dateStr = dateFormat.format(date);
                if (!TextUtils.isEmpty(dateStr) && dateStr.contains(" 0")) {
                    dateStr = dateStr.replace(" 0", " ");
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm"); //No i18n
                Date date = new Date(time * 1000);
                String dateStr = dateFormat.format(date);
                if (!TextUtils.isEmpty(dateStr) && dateStr.contains(" 0")) {
                    dateStr = dateStr.replace(" 0", " ");
