...
public final class RUtils {
    ...
    public static final String POINT = ".";//No i18n
    public static final String R = "R";//No i18n
    public static final String JOIN = "$";//No i18n
    public static final String ANIM = "anim";//No i18n
    public static final String ATTR = "attr";//No i18n
    public static final String COLOR = "color";//No i18n
    public static final String DIMEN = "dimen";//No i18n
    public static final String DRAWABLE = "drawable";//No i18n
    public static final String ID = "id";//No i18n
    public static final String LAYOUT = "layout";//No i18n
    public static final String MENU = "menu";//No i18n
    public static final String RAW = "raw";//No i18n
    public static final String STRING = "string";//No i18n
    public static final String STYLE = "style";//No i18n
    public static final String STYLEABLE = "styleable";//No i18n
