 ...
 */
@SuppressLint("InlinedApi")//No i18n
@TargetApi(Build.VERSION_CODES.GINGERBREAD)
public class DownloadManagerPro {

    public static final Uri CONTENT_URI = Uri
            .parse("content://downloads/my_downloads"); //No i18n
    /**
     * represents downloaded file above api 11 *
     */
    public static final String COLUMN_LOCAL_FILENAME = "local_filename";//No i18n
    /**
     * represents downloaded file below api 11 *
     */
    public static final String COLUMN_LOCAL_URI = "local_uri";//No i18n

    public static final String METHOD_NAME_PAUSE_DOWNLOAD = "pauseDownload";//No i18n
    public static final String METHOD_NAME_RESUME_DOWNLOAD = "resumeDownload";//No i18n
    ...
    public static class RequestPro extends Request {
        ...
        public static final String METHOD_NAME_SET_NOTI_CLASS = "setNotiClass";//No i18n
        public static final String METHOD_NAME_SET_NOTI_EXTRAS = "setNotiExtras";//No i18n
