...
public final class ShellUtils {
    ...
    public static final String COMMAND_SU = "su";//No i18n
    public static final String COMMAND_SH = "sh";//No i18n
    ...
    public static boolean checkRootPermission() {
        return execCommand("echo root", true, false).result == 0;//No i18n
    }
